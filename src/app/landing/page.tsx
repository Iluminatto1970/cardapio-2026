...
import { Check, Star, Users, TrendingUp, Smartphone, ShieldCheck, Clock, RefreshCw, Wallet, Headset, QrCode } from "lucide-react";
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { emoji: "💸", title: "Custo alto", desc: "Cada reimpressão custa R$ 50 a R$ 200. Por ano: até R$ 2.400!" },
              { emoji: "😰", title: "Preços desatualizados", desc: "Muda preço do insumo? Precisa reimprimir tudo." },
              { emoji: "📱", title: "Fora do digital", desc: "Seus clientes buscam no celular. Você perde vendas." },
            ].map((item) => (
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: Users, title: "Pedido no WhatsApp", desc: "Receba pedidos organizados" },
              ...
              { icon: RefreshCw, title: "Fácil de usar", desc: "Você gerencia sozinho" },
